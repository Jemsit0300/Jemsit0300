...
I build multilingual, data-driven REST APIs with **Django** and **Django REST Framework**, and take them all the way to production with **PostgreSQL**, **Nginx**, and **Gunicorn** — owning each project end to end, from data modeling to deployment. Comfortable working in **Ubuntu/Linux environments**, containerizing services with **Docker**, and managing servers over **SSH**.
...
<tr><td><b>Infra</b></td><td>Ubuntu/Linux, Docker &amp; Docker Compose, Nginx reverse proxy, SSH server administration</td></tr>
...
<img src="https://capsule-render.vercel.app/api?type=soft&color=15171C&height=90&section=footer" width="100%"/>
